...
from CPMP_Layers.Layers import Model_CPMP, LayerExpandOutput, ConcatenationLayer, Reduction
from CPMP.cpmp_ml import generate_random_layout, get_ann_state, get_move, Layout
...
def get_ann_state_v2(layout: cpmp_ml.Layout) -> np.ndarray:
    """
...
def load_cpmp_model(name: str) -> tuple:
    """
...
if __name__ == '__main__':
    cpmp_ml.get_ann_state = get_ann_state_v2
